...
def compress_single_file_subprocess(input_path: str, quality_range: str):
    ...
    try:
        ...
        command = [
            ...
            "--skip-if-larger",  # Do not save if file size increases (safe optimization)
            input_path,
            "--output",
        ...
        print(
            f"❌ Error: 'pngquant' command not found. Please ensure the 'pngquant' binary is installed and in your system PATH."
        )
...
if __name__ == "__main__":
    ...
    if not all_png_files:
        ...
        compress_task = partial(
            compress_single_file_subprocess, quality_range=QUALITY_RANGE_STR
        )
