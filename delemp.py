...
Features:
- Recursive (current dir)
- In-place
- Concurrent
- Excludes .git
- Extension whitelist from text_based.txt
- Reports total blank lines removed
- Reports per-extension stats
- Optional --collapse mode (keep single blank line)
"""
